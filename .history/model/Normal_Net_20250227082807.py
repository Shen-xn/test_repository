    ...
    def backward(ctx, grad_output):  # 定义逆向传播过程
        ...
        # and torch.randint(0, 2, (1,)) < 1:
            if O_prev_prev is not None and f_prime is not None and delta_k_minus1 is not None:
                ...
                # 应用补偿
                grad_output -= compensation * scaled_uniform_matrix
...
class NormNet(nn.Module):
    ...
    def __init__(self, activation_func, layer_dim, usebatchnorm=False, use_grad_norm=False, use_combination=False, gamma=0):  
        ...
        self.fc3 = CustomLinear(self.__dim, self.__dim, bias=1, use_grad_norm=use_grad_norm, use_combination=False, gamma=gamma)
        self.fc4 = CustomLinear(self.__dim, 1, bias=1, use_grad_norm=use_grad_norm, use_combination=False, gamma=gamma)
