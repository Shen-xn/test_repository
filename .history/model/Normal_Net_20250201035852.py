...
class NormNet(nn.Module):
    def __init__(self, activation_func, dim, usebatchnorm=False):
        ...
        self.fc4 = nn.Linear(self.__dim, self.__dim, bias=True)
        self.fc5 = nn.Linear(self.__dim, self.__dim, bias=True)
        self.fc6 = nn.Linear(self.__dim, self.__dim, bias=True)
        ...
        self.activation_func = activation_func # 激活函数negative_slope=0.1
        self.history = []
        self.param_history = []
