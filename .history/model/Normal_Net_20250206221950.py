...
class NormNet(nn.Module):
    ...
    def reset_parameters(self):
        # 手动设置fc1的权重和偏置
        nn.init.normal_(self.fc1.weight, mean=0, std=0.01)  # Xavier初始化
        nn.init.normal_(self.fc2.weight, mean=0, std=0.01)  # Xavier初始化
        nn.init.normal_(self.fc3.weight, mean=0, std=0.01)  # Xavier初始化
        nn.init.normal_(self.output_layer.weight, mean=0, std=0.01)  # Xavier初始化
