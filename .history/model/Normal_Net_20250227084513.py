...
class NormNet(nn.Module):
    ...
    def forward(self, x):
        ...
        a2 = self.fc2(o1, prev_layer_info=(x, a1, self.activation_func, use_comb)) 
        o2 = self.activation_func(a2)
        if self.usebatchnorm == True:
            o2 = self.batchnorm2(o2)  # 应用 BatchNorm1d 层
        a3 = self.fc3(o2, prev_layer_info=(o1, a2, self.activation_func, use_comb))
        o3 = self.activation_func(a3)
        if self.usebatchnorm == True:
            o3 = self.batchnorm3(o3)  # 应用 BatchNorm1d 层
        a4 = self.fc4(o3, prev_layer_info=(o2, a3, self.activation_func, use_comb))
