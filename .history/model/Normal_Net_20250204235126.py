...
class NormNet(nn.Module):
    ...
    def single_train_iter(self, data_set, batch_range, criterion, optimizer, use_alfa_normlize=False):
...
def train_normalnet(model, data_set, val_set, criterion, optimizer, scheduler=None, usealfanormalize=False, batch_size=100, num_epochs=1000, show_epoch=20):
    ...
    for epoch in range(num_epochs):
        ...
        running_loss = model.single_train_iter(data_set, batch_range, criterion, optimizer, usealfanormalize=usealfanormalize)
