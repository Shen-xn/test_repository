...
def train_normalnet(model, data_set, val_set, criterion, optimizer, scheduler=None, batch_size=100, num_epochs=1000, show_epoch=20):
    
    model.reset_parameters()
    initial_loss = model.validation(val_set, criterion, False).detach()
    losses = [initial_loss]
