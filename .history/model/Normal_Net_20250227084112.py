...
class NormNet(nn.Module):
    ...
    def __init__(self, activation_func, layer_dim, usebatchnorm=False, use_grad_norm=False, use_combination=False, gamma=0, take_rand=False):  
        ...
        self.fc3 = CustomLinear(self.__dim, self.__dim, bias=1, use_grad_norm=use_grad_norm, use_combination=False, gamma=gamma, take_rand=take_rand)
        self.fc4 = CustomLinear(self.__dim, 1, bias=1, use_grad_norm=use_grad_norm, use_combination=False, gamma=gamma, take_rand=take_rand)
